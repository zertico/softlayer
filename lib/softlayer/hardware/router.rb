module Softlayer
  class Hardware
    class Router < Softlayer::Hardware::Switch
      SERVICE = 'SoftLayer_Hardware_Router'
      autoload :Backend, 'softlayer/hardware/router/backend'
      autoload :Frontend, 'softlayer/hardware/router/frontend'
      ...
      def get_object
        request(:get_object, Softlayer::Hardware::Router)
      end
