module Softlayer
  class Network
    class Storage
      module Allowed
        class Host
          class Hardware < Softlayer::Network::Storage::Allowed::Host
            SERVICE = 'SoftLayer_Network_Storage_Allowed_Host_Hardware'
            ...
            def get_object
              request(:get_object, Softlayer::Network::Storage::Allowed::Host::Hardware)
            end
